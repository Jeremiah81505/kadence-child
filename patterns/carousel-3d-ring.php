 ...
 * Description: 3D rotating ring of brand logos with autoplay, visibility pause, keyboard nudge, and graceful fallback.
 *
 * Data attributes on <div class="es-ring">:
 * - data-speed  : seconds per revolution (defaults 28)
 * - data-radius : ring radius in px (omit for auto responsive)
 * - data-tilt   : tilt angle degrees (default 8)
 */
?>
...
<div class="wp-block-group alignfull kc-ring-wrap">
  <!-- wp:html -->
    <div class="es-stage" aria-label="<?php esc_attr_e( 'Brand logo carousel', 'kadence-child' ); ?>">
      <div class="es-ring" data-speed="30" data-tilt="8">
