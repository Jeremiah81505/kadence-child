<?php
/**
 * Title: 3D Logo Carousel – Ring (v2 Test)
 * Slug: kadence-child/carousel-3d-ring-v2
 * Categories: kadence-child, featured
 * Description: Test variant of the 3D rotating logo ring to verify registration & asset enqueue. Uses smaller tiles & slower spin.
 */
?>
<!-- wp:group {"align":"full","className":"kc-ring-wrap kc-ring-wrap--v2","style":{"spacing":{"padding":{"top":"42px","bottom":"42px"}}},"layout":{"type":"constrained","contentSize":"1900px"}} -->
<div class="wp-block-group alignfull kc-ring-wrap kc-ring-wrap--v2">
  <!-- wp:html -->
  <div class="es-stage" aria-label="<?php esc_attr_e( 'Brand logo carousel (variant 2)', 'kadence-child' ); ?>">
    <div class="es-ring" data-speed="40" data-tilt="10" data-size="100">
  ...
  <div class="es-fallback" aria-hidden="true">
