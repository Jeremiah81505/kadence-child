                    ...
                    <div class="wp-block-group kc-hero-head">
                        ...
                        <div class="wp-block-buttons kc-hero-ctas">
                            ...
                            <div class="wp-block-button kc-cta-primary">
                                <a class="wp-block-button__link wp-element-button" href="/get-a-quote/">&lrm;<?php esc_html_e( 'Get a Quote', 'kadence-child' ); ?>&lrm;</a>
                            </div>
                            <!-- /wp:button -->
                            <!-- wp:button {"className":"is-style-outline kc-cta-secondary kc-btn-blue"} -->
                            <div class="wp-block-button kc-cta-secondary kc-btn-blue">
                                <a class="wp-block-button__link wp-element-button" href="/color-samples/">&lrm;<?php esc_html_e( 'View Colors', 'kadence-child' ); ?>&lrm;</a>
                            </div>
                            <!-- /wp:button -->
                        </div>
                        <!-- /wp:buttons -->
