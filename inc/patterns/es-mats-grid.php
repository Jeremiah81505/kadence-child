...
<div id="es-mats" data-replay="true" data-stagger="140" style="max-width:1440px;margin:0 auto;padding:6px;color:#fff;font-family:inherit;">
    ...
    <style>
        ...
        @media (prefers-reduced-motion:reduce){#es-mats .es-card{opacity:1!important;transform:none!important;transition:none!important;}#es-mats .es-card._in::after{animation:none;}}
